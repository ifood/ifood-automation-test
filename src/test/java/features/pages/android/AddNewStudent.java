...
import features.elements_mapping.android.AddNewStudentMapping;
...
public class AddNewStudent extends AppiumActions {
    ...
    public boolean checkIfTheStudentAddedIsDisplayedInTheList(String studentCode, String studentName) {
        ...
        for (MobileElement item : addNewStudentMapping.getStudentCodeAndNameList()){
            status = item.getText().contains(studentCode) && item.getText().contains(studentName);
        }
        return status;
    }
